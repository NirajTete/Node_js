...
app.get("/", (req, res) => {
  ...
  res.render("index.ejs", {adjective: null, noun: null});
});
...
app.post("/submit", (req, res) => {
  ...
  const randaomAdj = adj[Math.floor(Math.random() *adj.length)];
  const randaomNoun = noun[Math.floor(Math.random() *noun.length)];
  res.render("index.ejs", {adjective: randaomAdj, noun: randaomNoun});
